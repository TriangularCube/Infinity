...
public class Interceptor : Terminal {
	...
	private void ApplyStationControl(){
		...
		rigidbody.velocity = Vector3.MoveTowards( rigidbody.velocity, targetTravelDirection * inputDirection.normalized * currentMaxSpeed, forceVector.magnitude * Time.deltaTime );
